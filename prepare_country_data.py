...
#year_RX5 
all_files=glob.glob('/p/projects/ikiimp/RCM_BC/ISIMIP2b_bc/GCMoutput/monthly/RX5/year_RX5_*')
for in_file in all_files:
	model=in_file.split('/')[-1].split('_')[2]
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='pr',given_var_name='year_RX5',data_type='CORDEX_BC',scenario=rcp,model=model,time_format='yearly',overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='consecutive_dry_days_index_per_time_period',given_var_name='Apr-Jul_cdd',data_type='CORDEX_BC',scenario=rcp,model=model,time_format='yearly',overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='consecutive_dry_days_index_per_time_period',given_var_name='Jun-Sep_cdd',data_type='CORDEX_BC',scenario=rcp,model=model,time_format='yearly',overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='consecutive_dry_days_index_per_time_period',given_var_name='May-Oct_cdd',data_type='CORDEX_BC',scenario=rcp,model=model,time_format='yearly',overwrite=True)

#10day_pr
all_files=glob.glob('/p/projects/ikiimp/RCM_BC/ISIMIP2b_bc/GCMoutput/monthly/10_day_below_1std/10day_mean_*')
for in_file in all_files:
	model=in_file.split('/')[-1].split('_')[2]
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
...
#10day_pr
all_files=glob.glob('/p/projects/ikiimp/RCM_BC/ISIMIP2b_bc/GCMoutput/monthly/10_day_below_1std/10day_below_-1std_*')
for in_file in all_files:
	model=in_file.split('/')[-1].split('_')[3]
	rcp=in_file.split('/')[-1].split('_')[4]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='pr',given_var_name='10day_below_1std_pr',data_type='CORDEX_BC',scenario=rcp,model=model,time_format='10day',overwrite=True)
...
COU.country_zoom('/p/projects/tumble/carls/shared_folder/EWEMBI/mon_year/year_RX5_EWEMBI_1979-2014.nc4',var_name='pr',given_var_name='year_RX5',data_type='EWEMBI',time_format='yearly',overwrite=True)
COU.country_zoom('/p/projects/tumble/carls/shared_folder/EWEMBI/mon_year/mon_RX5_EWEMBI_1979-2014.nc4',var_name='pr',given_var_name='mon_RX5',data_type='EWEMBI',time_format='monthly',overwrite=True)
...
COU.country_zoom('/p/projects/tumble/carls/shared_folder/EWEMBI/10day_pr/pr_10day_below_1std_EWEMBI_1979-2013.nc4',var_name='pr',given_var_name='10day_below_1std_pr',data_type='EWEMBI',time_format='10day',overwrite=True)
...
COU.country_zoom('/p/projects/tumble/carls/shared_folder/EWEMBI/mon_year/Jun-Sep_CDD_EWEMBI_1979-2014.nc4',var_name='consecutive_dry_days_index_per_time_period',given_var_name='Jun-Sep_cdd',data_type='EWEMBI',time_format='yearly',overwrite=True)
COU.country_zoom('/p/projects/tumble/carls/shared_folder/EWEMBI/mon_year/May-Oct_CDD_EWEMBI_1979-2014.nc4',var_name='consecutive_dry_days_index_per_time_period',given_var_name='May-Oct_cdd',data_type='EWEMBI',time_format='yearly',overwrite=True)
COU.country_zoom('/p/projects/tumble/carls/shared_folder/EWEMBI/mon_year/Apr-Jul_CDD_EWEMBI_1979-2014.nc4',var_name='consecutive_dry_days_index_per_time_period',given_var_name='Apr-Jul_cdd',data_type='EWEMBI',time_format='yearly',overwrite=True)
