...
for country_iso in isos:
	...
	try:
		...
		COU.create_mask_country('/p/projects/ikiimp/RCM_BC/ISIMIP2b_bc/GCMinput/monthly/pr/mon_pr_ECEARTH_historical_19510101-20101231.nc4','pr','/home/pepflei/CA/masks/shapefiles/world/ne_50m_admin_0_countries',overwrite=True)
		...
		COU.create_mask_admin('/p/projects/ikiimp/RCM_BC/ISIMIP2b_bc/GCMinput/monthly/pr/mon_pr_ECEARTH_historical_19510101-20101231.nc4','pr',COU._working_directory+country_iso+'_adm_shp/'+country_iso+'_adm1',overwrite=True)
