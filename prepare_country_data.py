...
country_iso='BEN'
COU=country_analysis(country_iso,'/p/projects/tumble/carls/shared_folder/country_analysis/'+country_iso+'_no_BC/')
...
for in_file in all_files:
	...
	COU.country_zoom(in_file,var_name='tas',data_type='CORDEX',scenario=rcp,model=model,overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='tasmax',given_var_name='TXx',data_type='CORDEX',scenario=rcp,model=model,overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='pr',data_type='CORDEX',scenario=rcp,model=model,overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='pr',given_var_name='year_RX5',data_type='CORDEX',scenario=rcp,model=model,overwrite=True)
...
for in_file in all_files:
	...
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='pr',given_var_name='RX1',data_type='CORDEX',scenario=rcp,model=model,overwrite=True)
...
for in_file in all_files:
	...
	rcp=in_file.split('/')[-1].split('_')[3]
	print rcp,model,in_file
	COU.country_zoom(in_file,var_name='consecutive_dry_days_index_per_time_period',given_var_name='year_CDD',data_type='CORDEX',scenario=rcp,model=model,overwrite=True)
...
# #TXx 
# all_files=glob.glob('/p/projects/ikiimp/RCM_BC/ISIMIP2b_bc/GCMoutput/monthly/mon_TXx_*')
# for in_file in all_files:
# 	model=in_file.split('/')[-1].split('_')[2]
# 	rcp=in_file.split('/')[-1].split('_')[3]
# 	print rcp,model,in_file
