...
GHA.create_mask('data/raw/SPEI/NCEP/SPEI_ncep_1948-2014_1m.nc','SPEI','masks/shapefiles/world/ne_50m_admin_0_countries',-180.0,mask_style='pop2015_weigthed',pop_mask_file='masks/population/population_1990_incrLat.nc')
...
GHA.create_mask('data/raw/SPEI/CMIP5/spei_hadgem2-es_rcp2.6_1950-2099_1m.nc','SPEI','masks/shapefiles/world/ne_50m_admin_0_countries',0.0,mask_style='pop2015_weigthed',pop_mask_file='masks/population/population_1990_incrLat.nc')
